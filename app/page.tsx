...
// --- HEADER COMPONENT (Matches the Screenshot) ---
...
function Header() {
  ...
  return (
    // Used a specific dark navy hex to match the screenshot
    <header className="bg-[#0B1120] border-b border-slate-800 py-4 px-6 md:px-8 flex flex-col md:flex-row justify-between items-center text-white font-sans print:hidden">
      ...
      <div className="flex items-center mb-4 md:mb-0 gap-4">
        ...
        <div className="flex flex-col justify-center">
          {/* Main Title - Extra Bold and Tight Tracking */}
          <h1 className="text-2xl font-extrabold tracking-tight text-white leading-none">
            RACK2CLOUD
          </h1>
          {/* Subtitle - Small, Uppercase, Spaced Out, Muted Blue-Grey */}
      ...
      <div className="flex items-center gap-3">
        {/* Share Button: Dark background with subtle border */}
        <button
          onClick={handleShare}
          className="group flex items-center px-4 py-2 bg-[#1e293b] hover:bg-[#334155] border border-slate-700 rounded-lg transition-all duration-200"
        >
        ...
        {/* PDF Button: Bright Blue (Royal/Inter) */}
        <button
          onClick={handlePrint}
